...
The API has also has a frontend interface written with HTML, CSS and JavaScript - the landing page contains an "About" section which links to both the API as well as a [Docs](https://nc-games-reviews.onrender.com/docs) section. This section contains a list of all possible endpoints on the API with details about the responses and request format (where relevant). The repo for the frontend of this project can be found [here](https://github.com/teyahbd/nc-games-reviews).
